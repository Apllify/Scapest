...
func _ready():
	...
	level_count_node.set_text("Level 4")
	...
	gem.scene_to_load = "res://Scenes/Level5.tscn"
	...
	cannon1.bullet_speed = 80
	cannon1.bullet_lifespan = 6
	...
	cannon2.bullet_speed = 80
	cannon2.bullet_lifespan = 6
