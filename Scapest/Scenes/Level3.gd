...
func _ready():
	...
	level_count_node.set_text("Level 3")
	...
	gem.max_gem_count = 8
	gem.scene_to_load = "res://Scenes/Level4.tscn"
	...
	cannon2.firing_rate = 1
	cannon2.bullet_speed = 100
	cannon2.bullet_lifespan = 2
	...
	cannon3.firing_rate = 2
	cannon3.bullet_speed = 80
	cannon3.bullet_lifespan = 3
	...
	cannon4.firing_rate = 2
	cannon4.bullet_speed = 80
	cannon4.bullet_lifespan = 3
